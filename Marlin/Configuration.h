...
#define STRING_CONFIG_H_AUTHOR "(Giacomo Di Paolo, Wanhao GR2 Stable)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_WANHAO_GR2
#endif
...
#define MAX_BED_POWER 200 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 97.88
  #define DEFAULT_bedKi 16.73
  #define DEFAULT_bedKd 381.86
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 19, -19, -2 }
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (105), 20 }
