#
# buildroot/share/PlatformIO/scripts/STM32F103VET6_GR2.py
#
import os
...
custom_ld_script = os.path.abspath("buildroot/share/PlatformIO/ldscripts/wanhao_gr2_stm32f103vet6.ld")
